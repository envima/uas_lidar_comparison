...
```{r, fig.cap="Comparison of the vertical point distribution of LiDAR and single date DAP"}
...
```{r, fig.cap="Comparison of the vertical point distribution of LiDAR and combined DAP in spring and fall"}
